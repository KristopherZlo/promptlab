...
class EvalaSmokeTest extends TestCase
{
    use RefreshDatabase;

    public function test_verified_user_can_render_core_evala_pages(): void
    {
        ...
        $team = app(TeamProvisioningService::class)->createTeam($user, [
            ...
            'description' => 'Workspace for Evala smoke coverage.',
        ]);
